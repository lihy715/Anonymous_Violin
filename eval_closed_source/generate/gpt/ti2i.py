...
def call_image_edit_api(prompt, base_img_path, mask_img_path, save_path, api_key=None):
    ...
    base64_full_img = encode_image(full_img_path)
    base64_full_mask = encode_image(full_mask_path)
    ...
    payload = json.dumps({
        ...
        "image": [
            f"data:image/jpeg;base64,{base64_full_img}",
            f"data:image/png;base64,{base64_full_mask}"
        ]
    })
